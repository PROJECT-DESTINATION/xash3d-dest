...
class PS3:
	...
	def linkflags(self):
		...
		linkflags = ['-L'+os.path.join(self.ps3sdk_dir,'host-win32','lib','prx','ldscripts'),'-L'+os.path.join(self.ps3sdk_dir,'host-win32','ppu','lib')]
		# enforce no-short-enums again
...
def configure(conf):
	if conf.options.ANDROID_OPTS:
		...
		conf.env.cxxprogram_PATTERN = ".self"
